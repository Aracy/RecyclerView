...
public class LoadMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final int LOAD_IN_STATE = 1; //加载中
    ...
    private boolean showAllLoadView = true;//是否显示全部加载完成的View
    ...
    public int getItemCount() {
        if (!showAllLoadView && loadMoreState == LOADED_ALL_STATE) {
            return adapter.getItemCount() == 0 ? 0 : adapter.getItemCount();
        }
